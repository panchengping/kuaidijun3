...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbOpenHelper = new DBOpenHelper(AddActivity.this, "expressTrade.db", null, 1);
        //获取添加单词的编辑框
        ...
        Button btn_Save = (Button) findViewById(R.id.save_btn);      //获取保存按钮
        Button btn_Cancel = (Button) findViewById(R.id.cancel_btn1); //获取取消按钮
        //实现将添加的单词解释保存在数据库中
    ...
    private void insertData(SQLiteDatabase readableDatabase, String word, String explain) {
        ...
        readableDatabase.insert("expressTrade", null, values);//执行插入操作
    }
}
